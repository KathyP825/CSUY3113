...
void Map::Build() {
    for (int y = 0; y < this->height; y++) {
        for (int x = 0; x < this->width; x++) {
            ...
            if (tile == 0) continue;        // if tile index == 0, don't draw anything because 1st tile is empty space
...
// map isn't transformed, just have basic model matrix
...
// find if is there is something solid there
