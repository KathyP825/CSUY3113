...
-   Entity.h -- change ints to floats
-   Entity.cpp -- replace collision check with new code
-   character floats because image doesn't go all the way to the edge
-   main.cpp -- fix player hovering
*/
