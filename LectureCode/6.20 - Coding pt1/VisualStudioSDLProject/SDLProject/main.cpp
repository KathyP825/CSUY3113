...
-   Entity.h -- initialize isActive as true
-   Entity.cpp -- Update(), Render(), CheckCollision() adds condition to don't bother to do anything if not active

-   tests middle platform with isActive set to false -- works
