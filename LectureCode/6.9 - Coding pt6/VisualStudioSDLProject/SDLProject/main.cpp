...
-   Entity.cpp -- add collision detection -- stop player from falling through platform
-   Entity.cpp -- update Update() to include list of entities you possibly need to collide with
-   Entity.h -- update Update() prototype to match
-   Entity.cpp -- add collision detection check for platforms
-   players falls onto platform but is stuck / can't move left and right
-   need to do some calculations to fix getting stuck
*/
